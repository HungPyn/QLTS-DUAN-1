...
public class ThongTinChiTietKhachHang extends javax.swing.JDialog {
    
    ViewDialog vd = new ViewDialog();
    
    public ThongTinChiTietKhachHang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btn_Huy.setBackground(new java.awt.Color(51, 204, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongTinChiTietKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThongTinChiTietKhachHang dialog = new ThongTinChiTietKhachHang(new javax.swing.JFrame(), true);
